...
#myresult = fmgapi.get_adom_by_name('root')
#myresult = fmgapi.get_adom_by_oid('3')
#myresult = fazapi.get_adom_list
#myresult = fmgapi.get_config('2', :dev_id => '234')
#myresult = fmgapi.get_config_revision_history(:dev_id => '234')
#myresult = fmgapi.get_device(:dev_id => '234')
#myresult = fmgapi.get_device_license_list
#myresult = fazapi.get_device_list
#myresult = fmgapi.get_device_list_detail
#myresult = fmgapi.get_device_vdom_list(:dev_id => '234')
#myresult = fmgapi.get_faz_archive({:devId => '234', :adom => 'root'})
#myresult = fazapi.get_faz_archive({:adom => 'root', :dev_id => 'FWF60D4613000043', :file_name => '1712625328:0', :type => '6'})
...
#myresult = fmgapi.get_group_list
#myresult = fmgapi.get_group({:groupid => '101', :name => 'All_FortiGate'})
#myresult = fmgapi.get_instlog({:sn => 'FGVM020000018110'})
#myresult = fmgapi.get_package_list('root')
#myresult = fmgapi.get_script('cli-sys-status')
